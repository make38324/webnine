    ...
    function Plugin(action, options) {
        ...
        return args = Array.prototype.slice.call(arguments, 1),
            this.each(function() {
                ...
                data || (data = new Tabs($this,$.extend(!0, {}, options)),
    ...
    Tabs = function(element, options) {
        ...
        Tabs.prototype.getTarget = function() {
            ...
            return selector = this.getSelector(),
                this.isCacheUsed() ? ("undefined" == typeof this.$target && (this.$target = this.getContainer().find(selector)),
            ...
            return tab = this,
                filterElements = function() {
                    ...
                    return $elements = tab.getContainerAccordion().filter(function() {
                        ...
                        "undefined" == typeof accordion && ($that.vcAccordion(),
                            accordion = $that.data("vc.accordion")),
                ...
                ,
                this.isCacheUsed() ? ("undefined" == typeof this.$relatedAccordion && (this.$relatedAccordion = filterElements()),
        ...
        Tabs.prototype.getTargetTab = function() {
            var $this;
            return $this = this.$element,
                this.isCacheUsed() ? ("undefined" == typeof this.$targetTab && (this.$targetTab = $this.closest(this.tabSelector)),
        ...
        Tabs.prototype.show = function() {
            this.getTargetTab().hasClass(this.activeClass) || (this.triggerEvent("show.vc.tab"),
                this.getTargetTab().addClass(this.activeClass))
        }
        ,
        Tabs.prototype.hide = function() {
            this.getTargetTab().hasClass(this.activeClass) && (this.triggerEvent("hide.vc.tab"),
        ...
        changeHandler = function(e) {
            ...
            "undefined" == typeof caller.getRelatedTab && (caller.getRelatedTab = function() {
                    var findTargets;
                    return findTargets = function() {
                        ...
                        return $targets = caller.getContainer().find("[data-vc-tabs]").filter(function() {
                            ...
                            "undefined" == typeof tab && $this.vcAccordion(),
                                tab = $this.data("vc.accordion"),
                            tab.getSelector() === caller.getSelector()
                        })
                    }
                        ,
                        caller.isCacheUsed() ? ("undefined" == typeof caller.relatedTab && (caller.relatedTab = findTargets()),
